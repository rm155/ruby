...
# define load_external_gc_func(name) do { \
    ...
    load_external_gc_func(absorb_contents);
    load_external_gc_func(attach_local_gate);
    ...
    load_external_gc_func(during_local_gc_p);
    load_external_gc_func(during_global_gc_p);
    load_external_gc_func(using_local_limits);
    ...
    load_external_gc_func(gc_deactivate_prepare);
    ...
    // Write barriers
    load_external_gc_func(writebarrier_gc_blocked);
    ...
    load_external_gc_func(object_id_local_search);
    ...
    // Miscellaneous
    load_external_gc_func(ractor_of_objspace);
    load_external_gc_func(local_gate_of_objspace);
    load_external_gc_func(objspace_of_value);
    load_external_gc_func(ractor_of_value);
...
{
    each_location_ptr(start, end, rb_gc_impl_stack_location_mark_maybe, rb_gc_get_objspace());
}
...
gc_mark_machine_stack_location_maybe(void *data, VALUE obj)
{
    ...
    gc_stack_location_mark_maybe_internal(objspace, obj);
    ...
    if (is_fake_frame) {
        each_location_ptr(fake_frame_start, fake_frame_end, rb_gc_impl_stack_location_mark_maybe, objspace);
    }
#endif
}
...
mark_current_machine_context(void *objspace, rb_execution_context_t *ec)
{
    ...
    each_location_ptr(rb_stack_range_tmp[0], rb_stack_range_tmp[1], rb_gc_impl_stack_location_mark_maybe, objspace);
...
mark_current_machine_context(void *objspace, rb_execution_context_t *ec)
{
    ...
    each_location_ptr(stack_start, stack_end, rb_gc_impl_stack_location_mark_maybe, objspace);
