...
// GC
GC_IMPL_FN void rb_gc_impl_start(void *objspace_ptr, bool full_mark, bool immediate_mark, bool immediate_sweep, bool global, bool compact);
GC_IMPL_FN bool rb_gc_impl_during_gc_p(void *objspace_ptr);
GC_IMPL_FN bool rb_gc_impl_during_local_gc_p(void *objspace_ptr);
GC_IMPL_FN bool rb_gc_impl_during_global_gc_p(void *objspace_ptr);
GC_IMPL_FN bool rb_gc_impl_using_local_limits(void *objspace_ptr);
...
// Object allocation
GC_IMPL_FN VALUE rb_gc_impl_new_obj(void *objspace_ptr, void *cache_ptr, VALUE klass, VALUE flags, VALUE v1, VALUE v2, VALUE v3, bool wb_protected, size_t alloc_size, bool borrowing);
GC_IMPL_FN size_t rb_gc_impl_obj_slot_size(VALUE obj);
GC_IMPL_FN size_t rb_gc_impl_heap_id_for_size(size_t size);
...
#if VM_CHECK_MODE > 0
GC_IMPL_FN void rb_gc_impl_permit_unshareable_references(VALUE obj);
GC_IMPL_FN bool rb_gc_impl_unshareable_references_permission_p(VALUE obj);
#endif
